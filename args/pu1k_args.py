...
def parse_pu1k_args():
    ...
    parser.add_argument('--h5_file_path', default="./data/LIULI/train/LIULI_poisson_512_and_poisson_2048.h5", type=str, help='the path of train dataset')
    parser.add_argument('--num_points', default=512, type=int, help='the points number of each input patch')
    ...
    parser.add_argument('--use_smooth_loss', default=True, type=str2bool, help='whether use smooth L1 loss')
    ...
    parser.add_argument('--grad_regularizer', default=0.001, type=float, help='regularization parameters used in gradient estimation')
    parser.add_argument('--grad_kernel_width', default=1, type=int, help='the gradient estimates the width of the medium Gaussian kernel')
    parser.add_argument('--centralize_first', default=True, type=str2bool, help='Whether or not the input of the first layer is centralized')
    parser.add_argument('--in_channels', default=3, type=int, help='')
    parser.add_argument('--conv_channels', default=[32, 32, 32], type=int, help='')
    parser.add_argument('--mlp_depth', default=2, type=int, help='')
    parser.add_argument('--alpha', default=0.2, type=float, help='Activation function of LeakyReLU')
    parser.add_argument('--gat_channels', default=32, type=int, help='in/out channels of GAT module')
    parser.add_argument('--concat', default=True, type=str2bool, help='whether or not concat')
